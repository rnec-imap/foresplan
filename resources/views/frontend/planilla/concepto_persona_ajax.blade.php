...
<tr style="font-size:13px" class="test" data-toggle="tooltip" data-placement="top">
	...
	<td class="text-left"><?php echo $row->mont_fijo_cmf?></td>
	<td class="text-left">
		<div class="btn-group btn-group-sm" role="group" aria-label="Log Viewer Actions">
			<button style="font-size:12px" type="button" class="btn btn-sm btn-success" data-toggle="modal" onclick="modalConceptoPersona(<?php echo $row->id?>,<?php echo $id_periodo?>,<?php echo $id_persona?>)" ><i class="fa fa-edit"></i> </button>
