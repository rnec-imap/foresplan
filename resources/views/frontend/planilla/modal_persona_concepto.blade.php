...
function fn_save(){
	...
	var id_periodo = $('#id_periodo_modal').val();
	var id_persona = $('#id_persona_modal').val();
	var precio = $('#precio').val();
	//alert(id_persona);return false;
    $.ajax({
			url: "/planilla/send_concepto_persona",
            type: "POST",
    ...
    <div>
		...
		<div class="card">
			...
			<div class="card-header" style="padding:5px!important;padding-left:20px!important">
				Edici&oacute;n Concepto Persona-> <?php echo $id_persona?>
			</div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
					...
					<input type="hidden" name="id_periodo_modal" id="id_periodo_modal" value="<?php echo $id_periodo?>">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input id="precio" name="precio" class="form-control form-control-sm"  value="<?php echo $concepto_persona->mont_fijo_cmf?>" type="text">
							</div>
						</div>
