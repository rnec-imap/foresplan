	...
	*/
	if(msg!=""){
		...
		$.ajax({
				...
				type: "POST",
				data : {_token:_token,id:id,fech_marc_rel:fech_marc_rel,hora_entr_rel:hora_entr_rel,fech_sali_rel:fech_sali_rel,hora_sali_rel:hora_sali_rel,hora_entrada,hora_salida},
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input id="persona_" name="persona_" class="form-control form-control-sm ui-autocomplete-input"  value="<?php echo $persona->apellido_paterno." ".$persona->apellido_materno." ".$persona->nombres?>" type="text" readonly="readonly">
						...
						<div class="row" onmouseover ="calculaDias()">							
							<div class="col-lg-3">
								<div class="form-group">
									...
									<input type="text" name="fech_marc_rel" id="fech_marc_rel" class="form-control form-control-sm" value="<?php echo $asistencia->fech_marc_rel?>"> 
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<input placeholder="Hora Inicio" type="time" wire:model="hora_entr_rel" id="hora_entr_rel" class="form-control form-control-sm" value="<?php echo $asistencia->hora_entr_rel?>">
										@error('horainicope') <span ...>Dato requerido</span> @enderror
								</div>
							</div>
							<div class="col-lg-3">
								<div class="form-group">
									<label class="control-label">F. Salida</label>
									<input type="text" name="fech_sali_rel" id="fech_sali_rel" class="form-control form-control-sm" value="<?php echo $asistencia->fech_sali_rel?>">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<input placeholder="Hora Fin" type="time" wire:model="hora_sali_rel" id="hora_sali_rel" class="form-control form-control-sm" value="<?php echo $asistencia->hora_sali_rel?>">
						...
						<div class="row" onmouseover ="calculaDias()">							
							<div class="col-lg-3">
								<div class="form-group">
									<label class="control-label">F. Ingreso Programado</label>
									<input type="text" name="fech_marc_rel" id="fech_marc_rel" class="form-control form-control-sm" value="<?php echo $asistencia->fech_marc_rel?>"> 
										@error('fech_inic_ope') <span ...>Dato requerido</span> @enderror										
								</div>
							</div>	
							<div class="col-lg-3">
								<div class="form-group">
									<label class="control-label">Hora Ingreso Programado</label>
									<input placeholder="Hora Ingreso" type="time" wire:model="hora_entrada" id="hora_entrada" class="form-control form-control-sm" value="<?php echo $asistencia->hora_entrada?>">
										@error('horaingresoope') <span ...>Dato requerido</span> @enderror
								</div>
							</div>
							<div class="col-lg-3">
								<div class="form-group">
									<label class="control-label">F. Salida Programado</label>
									<input type="text" name="fech_sali_rel" id="fech_sali_rel" class="form-control form-control-sm" value="<?php echo $asistencia->fech_sali_rel?>">
										@error('fech_fina_ope') <span ...>Dato requerido</span> @enderror										
								</div>
							</div>
							<div class="col-lg-3">
								<div class="form-group">
									<label class="control-label">Hora Salida Programado</label>
									<input placeholder="Hora Salida" type="time" wire:model="hora_salida" id="hora_salida" class="form-control form-control-sm" value="<?php echo $asistencia->hora_salida?>">
										@error('horasalidaope') <span ...>Dato requerido</span> @enderror										
								</div>
							</div>
						</div>
