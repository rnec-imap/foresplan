...
class CreatePlanillaCalculadaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('planilla_calculada');
        Schema::create('planilla_calculada', function (Blueprint $table) {
            ...
            $table->string('valo_calc_pca')->nullable();
            $table->timestamps();
        });
    }
